...
$(document).ready(function() {
  ...
  function getForecast(searchValue) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=755edf539dc7b350d3e6c65d81e6f713&units=imperial",
      dataType: "json",
      success: function(data) {
  ...
  function getUVIndex(lat, lon) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/uvi?appid=755edf539dc7b350d3e6c65d81e6f713&lat=" + lat + "&lon=" + lon,
      dataType: "json",
      success: function(data) {
